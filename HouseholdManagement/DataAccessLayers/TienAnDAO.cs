    ...
    public class TienAnDAO : DBConnection
    {
        ...
        public DataTable SelectAllTienAn()
        {
            try
            {
                ...
                command.Connection = connection;
                command.CommandText = "TienAn_SelectAll";
                command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable SelectTienAnById(int id)
        {
            try
            {
                ...
                SqlDataAdapter adapter;
                command.Connection = connection;
                command.CommandText = "TienAn_SelectById";
                command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable SelectTienAnByCongDanId(int id)
        {
            try
            {
                if (connection.State != ConnectionState.Open)
                ...
                SqlDataAdapter adapter;
                command.Connection = connection;
                command.CommandText = "[TienAn_SelectTienAnByCongDanId]";
                command.CommandType = CommandType.StoredProcedure;
